 ...
 *
 * This class manages the state for the marketplace view in the Piramyd Agent extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Piramyd Agent extensions interface
